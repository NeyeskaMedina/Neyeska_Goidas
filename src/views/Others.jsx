...
<Box sx={{display: 'flex', flexDirection: 'column'}}>
        ...
        <Box className="card_Other"> 
            <Box className="collapseNone" sx={{display: 'flex', flexDirection: 'column'}}>
                <img 
            ...
            <Box className="collapseNone" sx={{display: 'flex', flexDirection: 'column', marginBottom: '12vh'}}>
                <img 
